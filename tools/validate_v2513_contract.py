...
# Release/version publication and canonical release-history policy.
require("CMakeLists.txt", "VERSION 2.5.13")
require("CHANGELOG.md", "## 2.5.13")
require("RELEASE_NOTES.md", "SandHybrid v2.5.13")
require(".github/workflows/ci-release.yml", "SandHybrid-Windows-x64-v2.5.13")
require(".github/workflows/ci-release.yml", "gh release create v2.5.13")
...
evidence = {
    ...
    "MC-013": (("shaders/tiles.comp", ("bool macroLiquid = fullLiquid && !moving",)),),
