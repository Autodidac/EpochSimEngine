...
MATERIALS = [
    ...
    ('insect_habitat', 'Insect habitat', 175, 145, 180, 220, 'STRONG: SHELTER / BREEDING', 'WEAK: FIRE / ACID / DRYNESS', 'TO: ANTS / BEETLES / WASTE', 'ROLE: INSECT POPULATION SOURCE', 'DANGER: INFESTATION'),
