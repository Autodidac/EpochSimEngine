...
inline constexpr std::array<MaterialProfile, material_count> material_profiles{{
    ...
    {1u, 0u, 1u, 255u, 500, 32767, 32767, 32767, 32767, 32767, 8u, MaterialPhase::gas, "Heat", "STRONG: HEAT CARRIER", "WEAK: STEAM / PLANTS", "TO: DIRTY STEAM / CO2", "ROLE: CARBON TRANSPORT", "DANGER: SUFFOCATION"},
