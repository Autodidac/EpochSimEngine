...
static_assert(sandhybrid::material_profile(Material::acid).base_phase == MaterialPhase::liquid);
static_assert(sandhybrid::material_profile(Material::smoke).density <
              sandhybrid::material_profile(Material::atmosphere).density);
...
static_assert(sandhybrid::policy::update_vent_pressure(100u, true, false) == 120u);
static_assert(sandhybrid::policy::update_vent_pressure(100u, false, true) == 108u);
