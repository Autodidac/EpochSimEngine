...
const uint TILE_REBUILD_OCCUPANCY = 52u;
const uint TILE_BREAK_OCCUPANCY = 32u;
const uint TILE_STABILIZE_TICKS = 120u;
const uint TILE_REBUILD_COOLDOWN = 240u;
...
const uint TILE_RECONSTRUCT = 0x00000020u;
...
struct TileState {
    ...
    uint occupancy;
    uint flags;
    uint counters; // low 16: stable ticks, high 16: rebuild cooldown
};
