...
const uint FIXED_TEXT_WORDS_BASE = 167u;
const uint FIXED_TEXT_COUNT = 166u;
...
const uint MATERIAL_TEXT_OFFSETS_BASE = 490u;
const uint MATERIAL_TEXT_WORDS_BASE = 558u;
...
const uint GROUP_TEXT_OFFSETS_BASE = 667u;
const uint GROUP_TEXT_WORDS_BASE = 676u;
...
const uint SCENE_TEXT_OFFSETS_BASE = 690u;
const uint SCENE_TEXT_WORDS_BASE = 700u;
...
const uint PHASE_TEXT_OFFSETS_BASE = 722u;
const uint PHASE_TEXT_WORDS_BASE = 732u;
...
const uint GROUP_MATERIAL_BASE = 752u;
const uint GROUP_MATERIAL_COUNTS_BASE = 744u;
...
const uint CARD_TEXT_OFFSETS_BASE = 832u;
const uint CARD_TEXT_WORDS_BASE = 1503u;
