...
const uint FIXED_TEXT_WORDS_BASE = 144u;
const uint FIXED_TEXT_COUNT = 143u;
...
const uint MATERIAL_TEXT_OFFSETS_BASE = 413u;
const uint MATERIAL_TEXT_WORDS_BASE = 480u;
...
const uint GROUP_TEXT_OFFSETS_BASE = 589u;
const uint GROUP_TEXT_WORDS_BASE = 598u;
...
const uint SCENE_TEXT_OFFSETS_BASE = 612u;
const uint SCENE_TEXT_WORDS_BASE = 622u;
...
const uint PHASE_TEXT_OFFSETS_BASE = 644u;
const uint PHASE_TEXT_WORDS_BASE = 654u;
...
const uint GROUP_MATERIAL_BASE = 674u;
const uint GROUP_MATERIAL_COUNTS_BASE = 666u;
...
const uint CARD_TEXT_OFFSETS_BASE = 754u;
const uint CARD_TEXT_WORDS_BASE = 1415u;
